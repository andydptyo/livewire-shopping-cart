<div class=>
    <nav class="flex items-center justify-between flex-wrap p-6 mb-6 bg-teal-500 shadow">
        ...
        <div class="w-full block flex-grow text-white lg:flex lg:items-center lg:w-auto">
